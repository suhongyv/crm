        ...
        <#if permissions??>
            <#if permissions?seq_contains("10")>
                <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
                    <#if permissions?seq_contains("1010")>
                        <a href="javascript:openTab('营销机会管理','sale_chance/index','icon-yxjhgl')"
                           class="easyui-linkbutton"
                           data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">营销机会管理</a>
                    </#if>
                    <#if permissions?seq_contains("1020")>
                        <a href="javascript:openTab('客户开发计划','cus_dev_plan/index','icon-khkfjh')"
                           class="easyui-linkbutton"
            ...
            <#if permissions?seq_contains("20")>
                <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
                    ...
                    <#if permissions?seq_contains("2020")>
                        <a href="javascript:openTab('客户流失管理','customerLoss/index','icon-khlsgl')"
                           class="easyui-linkbutton"
            ...
            <#if permissions?seq_contains("60")>
                <div title="系统管理" data-options="iconCls:'icon-item'" style="padding:10px">
                    ...
                    <a href="javascript:openTab('用户管理','user/index','icon-user')" class="easyui-linkbutton"
                       data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">用户管理</a>
                    <a href="javascript:openTab('角色管理','role/index','icon-sjzdgl')" class="easyui-linkbutton"
                       data-options="plain:true,iconCls:'icon-sjzdgl'" style="width: 150px;">角色管理</a>
                    <a href="javascript:openTab('菜单管理','module/index/1','icon-sjzdgl')" class="easyui-linkbutton"
                       data-options="plain:true,iconCls:'icon-sjzdgl'" style="width: 150px;">菜单管理</a>
                </div>
            </#if>
        </#if>
