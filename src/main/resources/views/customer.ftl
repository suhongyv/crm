...
<div id="tb">
    <div>
        ...
        <a href="javascript:" class="easyui-linkbutton" iconCls="icon-remove" plain="true">联系人管理</a>
        <a href="javascript:" class="easyui-linkbutton" iconCls="icon-remove" plain="true">交往记录</a>
        <a href="javascript:" class="easyui-linkbutton" iconCls="icon-remove" plain="true">订单查看</a>
    </div>
    <div>
        客户名称： <input type="text" id="name" size="20" onkeydown="if(event.keyCode==13) searchCustomersByParams()"/>
        客户编号： <input type="text" id="khno" size="20" onkeydown="if(event.keyCode==13) searchCustomersByParams()"/>
