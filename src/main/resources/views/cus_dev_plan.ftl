...
<div id="dlg" class="easyui-dialog" style="width:800px;height:400px" resizable="true"
     closed="true">
    <#--营销机会详情展示-->
    <div id="p" class="easyui-panel" style="width: 700px;height: 300px;padding: 10px">
        <form id="fm">
            <table cellspacing="8px">
                ...
                <tr>
                    <td>概要：</td>
                    <td colspan="4"><input type="text" id="overView" name="overView" style="width: 420px"
    ...
    <table id="dg02" class="easyui-edatagrid" title="开发计划项"
        ...
        <tr>
            ...
            <th field="planDate" name="planDate" width="50"
    ...
    <div id="toolbar">
        <a href="javascript:$('#dg02').edatagrid('addRow')" class="easyui-linkbutton dlgbtn" iconCls="icon-add" plain="true" >添加计划</a>
        <a href="javascript:delCusDevPlan()" class="easyui-linkbutton dlgbtn" iconCls="icon-remove" plain="true" >删除计划</a>
        <a href="javascript:saveCusDevPlan()" class="easyui-linkbutton dlgbtn" iconCls="icon-save" plain="true" >保存计划</a>
        <a href="javascript:$('#dg02').edatagrid('cancelRow')" class="easyui-linkbutton dlgbtn" iconCls="icon-undo"
           plain="true" >撤销行</a>
        <a href="javascript:updateSaleChanceDevResult(2)" class="easyui-linkbutton dlgbtn" iconCls="icon-kfcg" plain="true" >开发成功</a>
        <a href="javascript:updateSaleChanceDevResult(3)" class="easyui-linkbutton dlgbtn" iconCls="icon-zzkf" plain="true" >终止开发</a>
    </div>
</div>
